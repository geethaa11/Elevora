...
export function Hero() {
  ...
  return (
    <section id="home" className="relative flex min-h-[120vh] flex-col items-center justify-center overflow-hidden pt-20 pb-32">
      <motion.div 
        variants={container}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true }}
        className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto pointer-events-auto"
      >
        <motion.div variants={item} className="mb-6">
          <Logo fullLockup />
        </motion.div>

        <motion.h2 variants={item} className="text-xl sm:text-2xl md:text-3xl text-neutral-200 font-medium mb-8 font-display tracking-wide drop-shadow-md">
        ...
        <motion.div variants={item} className="flex flex-col sm:flex-row items-center gap-6">
          <Link to="/signup">
            <Button variant="primary" size="lg" className="px-8 font-semibold rounded-full bg-gradient-to-b from-[#D4AF37] to-[#996515] text-black border-none hover:opacity-90">
